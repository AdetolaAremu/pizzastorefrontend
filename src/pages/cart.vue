<template>
  ...
  <div class="pt-52 pb-28 inset-0" v-if="countCartItems === 0 && loading === false || $store.state.isAuthenticated===false">
  ...
  <div v-if="loading === true && $store.state.isAuthenticated===true" wire:loading class="overflow-hidden py-36 mt-3 opacity-75 flex flex-col items-center justify-center">
