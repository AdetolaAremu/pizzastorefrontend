          ...
          <div class="grid grid-cols-1 -mx-3 mb-6 relative">
            <div class="w-full lg:w-96 px-3">
              ...
              >
                <label
                  v-if="!showPassword"
                  class="rounded px-2 py-1 mt-5 text-sm text-gray-600 font-mono cursor-pointer js-password-label"
                  for="toggle"
                >
                  <svg
                    class="w-6 h-6"
                ...
                >
                  ...
                  >
                    ...
                    6.578A9.98 9.98 0 00.458 10c1.274 4.057 5.065 7 9.542 7 .847 0 1.669-.105 2.454-.303z"
                    ></path>
                  </svg>
                </label>
              </div>
  ...
  setup() {
    ...
    watchEffect(() => {
      ...
      if (store.state.errorResponse != null) {
        toast.error(store.state.errorResponse, {
          timeout: 5000,
        });
